...
global conn,cursor
conn = mysql.connector.connect(host='localhost', database=' parking_system', user='root', password='toor')
...
def add_parking_type_record():
    ...
    cursor.execute('insert into parking_type(name,price) values("{}",{});'.format(name,price))
